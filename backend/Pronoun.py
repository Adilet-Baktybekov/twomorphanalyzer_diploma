...
def cases_pronoun_root(root):
    if root in prn_gen:
        return 'gen'
    elif root in prn_dat:
        return 'dat'
    elif root in prn_acc:
        return 'acc'
    elif root in prn_loc:
        return 'loc'
    elif root in prn_abl:
        return 'abl'
all_pronoun ={
    ...
    'алда ким','алда эмне','алда не','алда кандай','алда качан','алда канча',
                      ...
                      'бирдеме','неме','кайсы бир','кай бир','кээ бир','бири','кайсы бирөө', 'менин','сенин','анын',
    'мага','сага','ага', 'мени','сени','аны', 'анда', 'андан', 'муну'
}
...
prn_gen = {'менин','сенин','анын'}
prn_dat = {'мага','сага','ага'}
