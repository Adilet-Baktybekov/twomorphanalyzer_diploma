...
def cases_pronoun_root(root):
    if root in backend.sourceModule.prn_gen:
        return 'gen'
    elif root in backend.sourceModule.prn_dat:
        return 'dat'
    elif root in backend.sourceModule.prn_acc:
        return 'acc'
    elif root in backend.sourceModule.prn_loc:
        return 'loc'
    elif root in backend.sourceModule.prn_abl:
        return 'abl'
